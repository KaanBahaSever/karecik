...
export default function Landing() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      <Header kayitAc={() => setKayitAcik(true)} />

      <main className="flex-1">
        <section className="mx-auto grid max-w-icerik grid-cols-1 items-center gap-14 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:py-24">
          {/* sol sütun: anlatım */}
          <div className="max-w-xl">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              İşletmeniz için QR arayüzü
            </h1>

            <p className="mt-6 text-lg text-gray-600">
              QR menü hizmetimizle satışlarınızı kolaylaştırıp arttırma deneyimini yaşayın.
            </p>
          ...
          <div className="flex justify-center lg:justify-end">
            <IPhoneCerceve>
              <iframe src="/demo" title="Örnek kafe menüsü" className="h-full w-full border-0" />
            </IPhoneCerceve>
          </div>
        </section>
      </main>
      ...
      <footer className="border-t border-gray-200">
        <div className="mx-auto flex max-w-icerik flex-col items-center justify-between gap-3 px-4 py-6 sm:flex-row sm:px-6">
          <p className="text-sm text-gray-500">© 2026 Karecik</p>
